	...
	const J = [
		function ({ swiper: e, extendParams: t, on: s }) {
			...
			function i(t) {
				...
				if (
					...
					return (
						e.slidesGrid !== p && b !== u && e.slides.css(m, `${b}px`), void e.updateProgress()
					);
			...
			function g(t) {
				...
				if (
					...
					const t = { time: u(), delta: Math.abs(h), direction: Math.sign(h) },
						i =
							l && t.time < l.time + 500 && t.delta <= l.delta && t.direction === l.direction;
					if (!i) {
						...
						if (
							...
							const s = c.length ? c[c.length - 1] : void 0,
								a = c[0];
							if ((c.push(t), s && (t.delta > s.delta || t.direction !== s.direction)))
								c.splice(0);
							else if (
								c.length >= 15 &&
								t.time - a.time < 500 &&
					...
					if (
						(c.push(s),
						a
							? (s.direction !== a.direction || s.delta > a.delta || s.time > a.time + 150) &&
							  f(s)
							: f(s),
						(function (t) {
		...
		function ({ swiper: e, extendParams: t, on: s, emit: i }) {
			...
			function w(t) {
				...
				let r;
				(r =
					(v(t) - i.offset()[e.isHorizontal() ? 'left' : 'top'] - (null !== n ? n : l / 2)) /
					(o - l)),
					...
					(() => {
						...
						if (e.params.history) {
							if (!t.history || !t.history.pushState)
								return (
									(e.params.history.enabled = !1), void (e.params.hashNavigation.enabled = !0)
								);
							(a = !0),
								(i = l(e.params.url)),
								(i.key || i.value) &&
						...
						c.shadow &&
							(p
								...
								: ((h = t.find('.swiper-cube-shadow')),
								  0 === h.length &&
										((h = d('<div class="swiper-cube-shadow"></div>')), t.append(h))));
						for (let e = 0; e < a.length; e += 1) {
							const t = a.eq(e);
							let s = e;
